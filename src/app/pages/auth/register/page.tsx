...
const Register = () => {
  return (
    ...
    <form className='  h-[300px] w-[500px] flex flex-col justify-center items-center gap-5' action="">
      ...
      <button className='p-3 bg-[green] w-[100px] rounded text-[white] cursor-pointer'>Sign Up</button>
    </form>
    <span>Already have an account? <a className='text-[red] text-[18px] font-[700]' href="/pages/auth/login">Sign In</a></span>
  </div>
  </section>
  )
}
