  ...
  return (
    <section className='w-full flex items-center justify-center '>
      ...
      <form className='  h-[300px] w-[500px] flex flex-col justify-center items-center gap-5' action="">
        ...
        <button className='p-3 bg-[green] hover:bg-[#559055] w-[100px] rounded text-[white] cursor-pointer'>Log in</button>
      </form>
      <span>Dont you have an account? <a className='text-[red] underline text-[18px] font-[700]' href="/pages/auth/register">Register</a></span>
    </div>
    </section>
  )
}
